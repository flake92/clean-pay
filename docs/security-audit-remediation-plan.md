...
| 2026-08-03 | CHG-026 | Исправление авторизации | Clean Pay + Remnashop source/tests | Удалён ложный запрос «пароля от e-mail», добавлено автоматическое восстановление upstream-сессии и readiness-проверка нового контракта | Завершено | Clean Pay: ESLint, typecheck, `702/702`; Remnashop: Ruff, mypy `542`, `182/182`; отдельный регрессионный тест подтверждает Passkey recovery без password/link запроса | Codex |
