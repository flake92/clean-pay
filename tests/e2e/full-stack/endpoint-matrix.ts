...
export const telegramBusinessCases: EndpointMatrixCase[] = [
  ...
  { method: "POST", path: "/api/bff/subscription/promocode", body: { code: "NOPE" }, statuses: [409], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
