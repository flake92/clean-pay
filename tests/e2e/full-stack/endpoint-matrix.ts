...
export const telegramBusinessCases: EndpointMatrixCase[] = [
  ...
  { method: "GET", path: "/api/bff/subscription/current", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: subscriptionReadFlow, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/subscription/offers", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/subscription/devices", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "DELETE", path: "/api/bff/subscription/devices", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "DELETE", path: "/api/bff/subscription/devices/missing-device", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/promocode", body: { code: "NOPE" }, statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/reissue", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  ...
  { method: "GET", path: "/api/bff/payments/history", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/payments/status", statuses: [401], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
