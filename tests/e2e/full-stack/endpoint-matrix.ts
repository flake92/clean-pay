...
export const anonymousPublicCases: EndpointMatrixCase[] = [
  ...
  { method: "POST", path: "/api/bff/auth/email/start", body: { email: "nobody@example.com" }, statuses: [202], session: "none", verifiedEmail: "not-required", upstream: emailFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/email/complete", body: { email: "nobody@example.com", code: "000000", password: "bad-password" }, statuses: [400, 429], session: "none", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/password/reset/start", body: { email: "nobody@example.com" }, statuses: [202], session: "none", verifiedEmail: "not-required", upstream: emailFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/password/reset/confirm", body: { email: "nobody@example.com", code: "000000", newPassword: "bad-password" }, statuses: [400, 429], session: "none", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
...
export const unverifiedAllowedCases: EndpointMatrixCase[] = [
  { method: "GET", path: "/api/me", statuses: [200], session: "unverified-email", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/auth/me", statuses: [200], session: "unverified-email", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
...
export const unverifiedBlockedCases: EndpointMatrixCase[] = protectedEndpoints
  .filter((entry) => ["/api/bff/subscription/purchase", "/api/bff/subscription/extend"].includes(entry.path))
  .map((entry) => ({
    ...entry,
    body: {
...
export const telegramBusinessCases: EndpointMatrixCase[] = [
  ...
  { method: "GET", path: "/api/bff/subscription/current", statuses: [200], session: "telegram", verifiedEmail: "not-required", upstream: subscriptionReadFlow, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/subscription/offers", statuses: [200], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "GET", path: "/api/bff/subscription/devices", statuses: [404], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "DELETE", path: "/api/bff/subscription/devices", statuses: [409], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "DELETE", path: "/api/bff/subscription/devices/missing-device", statuses: [409], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/promocode", body: { code: "NOPE" }, statuses: [404, 409], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/reissue", statuses: [409], session: "telegram", verifiedEmail: "not-required", upstream: remnashopFlow, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/purchase", body: { plan_code: "missing", duration_days: 30, gateway_type: "TEST" }, statuses: [400], session: "telegram", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/subscription/extend", body: { duration_days: 30, gateway_type: "TEST" }, statuses: [400], session: "telegram", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
...
export const malformedPayloadCases: EndpointMatrixCase[] = [
  ...
  { method: "POST", path: "/api/bff/auth/login", body: {}, statuses: [410], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/register", body: {}, statuses: [410], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/email/start", body: {}, statuses: [400], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/email/complete", body: {}, statuses: [400, 422], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/password/reset/start", body: {}, statuses: [400], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
  { method: "POST", path: "/api/bff/auth/password/reset/confirm", body: {}, statuses: [400, 422], session: "none", verifiedEmail: "not-required", upstream: cleanPayOnly, unexpected5xx: "bug" },
