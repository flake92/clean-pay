...
if (configuredBaseUrl !== "https://pay.ci.clean-pay.dev"
  ...
  throw new Error("Candidate unverified e-mail Playwright configuration is invalid.");
}

export default defineConfig({
  testDir: ".",
  testMatch: "existing-unverified-email.candidate.spec.ts",
  ...
  projects: [{
    name: "candidate-unverified-email-1440x900",
    use: {
