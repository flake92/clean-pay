...
process.env.TELEGRAM_OIDC_AUTHORIZATION_ENDPOINT = "https://oauth.telegram.org/auth";
process.env.TELEGRAM_OIDC_TOKEN_ENDPOINT = "https://oauth.telegram.org/token";
process.env.TELEGRAM_OIDC_JWKS_URI = "https://oauth.telegram.org/.well-known/jwks.json";
process.env.TELEGRAM_OIDC_CLIENT_ID = "test-telegram-client-id";
