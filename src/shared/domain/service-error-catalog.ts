export const SERVICE_ERROR_PUBLIC_MESSAGES = {
...
export type PublicServiceErrorCode = keyof typeof SERVICE_ERROR_PUBLIC_MESSAGES;

export function serviceErrorPublicMessage(code: string) {
  return Object.prototype.hasOwnProperty.call(SERVICE_ERROR_PUBLIC_MESSAGES, code)
    ? SERVICE_ERROR_PUBLIC_MESSAGES[code as PublicServiceErrorCode]
    : undefined;
}
