...
## Перед шагом 11
- Нужны ли действия управления устройствами: удалить одно устройство и удалить все?
- Нужна ли кнопка перевыпуска subscription URL через `/subscription/reissue`?
- Нужен ли ввод промокода в кабинете через `/subscription/promocode`?
