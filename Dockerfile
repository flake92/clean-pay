...
COPY --from=builder --chown=cleanpay:nodejs /app/deploy/prod/start.sh /app/deploy/prod/validate-env.mjs /app/deploy/prod/reconcile-loop.mjs /app/deploy/prod/reconciliation-batch.mjs ./deploy/prod/
