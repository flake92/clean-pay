...
## 10. Dev-only интеграции / моки

Для разработки есть локальные заглушки.
...
scripts/dev/remnashop-mock.mjs
scripts/dev/turnstile-mock.mjs
```
...
Mailpit SMTP dev-сервер
```

В production это не основные интеграции.
...
9. Dev-only: Remnashop mock, Turnstile mock, Mailpit
```
