...
| Положительных строк | `6 — только управляющие документы, cycle 0` |
| Строк с отрицательным/непроверенным статусом | `552 из 558` |
...
| ROOT-015 | `software-spec/README.md` | актуальное состояние после удаления и навигация к Rails-планам | repository state | ДА | ДА: удалённый код не используется как источник | ДА: локальные ссылки проверены, цикл 0 |
| ROOT-016 | `software-spec/RUBY_MONOLITH_CLEANUP_PLAN.md` | завершённая cleanup-запись без разрешения новых удалений | repository state | ДА | ДА: граница монолита сохранена | ДА: состояние согласовано, цикл 0 |
| ROOT-017 | `software-spec/09-traceability/deletion-readiness-report.md` | историческое доказательство и текущий статус завершения удаления | traceability | ДА | ДА: история отделена от текущего состояния | ДА: состояние согласовано, цикл 0 |
| ROOT-018 | `software-spec/09-traceability/reimplementation-readiness-manifest.md` | post-analysis state и актуальные hashes управляющих документов | traceability | ДА | ДА: нормативные контракты не изменены | ДА: checksum проверен, цикл 0 |
